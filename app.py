...
# Función para inyectar el logo SVG
def render_svg(svg_code):
    b64 = base64.b64encode(svg_code.encode('utf-8')).decode("utf-8")
    html = f'<div style="text-align: center;"><img src="data:image/svg+xml;base64,{b64}" width="300"/></div>'
    st.write(html, unsafe_allow_html=True)

# Nueva versión del Logo SVG (Blanco y Rojo)
