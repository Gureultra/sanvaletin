    ...
    try:
        with st.spinner('Analizando actividad...'):
            ...
            if hr_records:
                ...
                with c2:
                    st.write("**Gráfica de Esfuerzo (BPM):**")
...
try:
    ...
    if ranking is not None and not ranking.empty:
        ...
        st.info("Aún no hay datos en el ranking. ¡Sé el primero en subir tu actividad!")
except:
